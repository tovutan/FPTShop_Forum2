...
namespace Model.Mapping.Identity
{
    public partial class UserMap:BaseMap<User>
    {
        ...
        {
            this.ToTable("User");
            this.HasKey(u => u.Id).Property(u => u.Id).HasColumnType("Int").IsRequired();
            this.Property(u => u.UserName).HasMaxLength(256).HasColumnAnnotation("Index", new IndexAnnotation(new IndexAttribute("UserNameIndex") { IsUnique = false }));
