...
namespace Model.Services.Web
{
    public class CategoryServices:BaseServices
    {
        ...
        // Lấy ra List Category có ParentID 
        ...
        public List<Category> GetListUrl(string catChildURL)
        {
            var _return = _DefaultListCategory.Where(c => c.UrlSlug.CompareTo(catChildURL) == 0);
            return _return.ToList();
        }
